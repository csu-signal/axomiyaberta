...
#             )
    ...
    def generate_cls_arg_vectors(self, input_ids, attention_mask, position_ids,
        ...
        last_hidden_states = output.last_hidden_state #might have to manipulate here to get other hidden layers results 
        cls_vector = output.pooler_output
...
#                                                arg1=arg1, arg2=arg2)
        ...
        option_token_output= self.generate_model_output_cosalign(input_ids, attention_mask=attention_mask,
                                               ...
                                               arg1=arg1, arg2=arg2)
#         if lm_only:
#             return self.option(option_token_output)  #ue this for QA
        
        if lm_only:
            return lm_output #wiki section frozen training
